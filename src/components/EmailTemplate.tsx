    ...
    useEffect(() => {
        if (selectedRep) {
            setText(
                ...
                `The rapid advancement of FRT and the deeply personal nature of biometric data make it critical that our laws and policies keep pace. Unlike passwords or credit cards, our facial data cannot be changed once it is compromised, which means we need strict protections to prevent misuse and discrimination.\n\n` +
                `Some states and cities have already taken action, such as Illinois’ Biometric Information Privacy Act (BIPA), which requires informed written consent for the collection of biometric data, and local bans in San Francisco and Somerville on government use of FRT without oversight. These are important steps, but a patchwork of local laws is not enough to protect people across all communities. Whether at the federal, state, or local level, comprehensive protections are urgently needed.\n\n` +
                ...
                `I strongly encourage you to take leadership on this issue and help shape legislation that protects communities while ensuring technology serves the public good.\n\n` +
